...
const TICKER_TEXT = "CONTINUIDADE • EVOLUÇÃO • DASHBOARD EM TEMPO REAL • NOVAS FUNCIONALIDADES • FEEDBACK DAS MÃES • SUPORTE DEDICADO • ";
...
export const MarqueeTicker = ({ reverse = false }: MarqueeTickerProps) => {
  return (
    <div className="overflow-hidden py-3 sm:py-4 bg-primary/90 backdrop-blur-sm border-y border-white/10 relative z-20">
      ...
      >
        <span className="text-[10px] sm:text-xs font-bold tracking-[0.6em] text-background uppercase">
